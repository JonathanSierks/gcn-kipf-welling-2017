# Graph Convolutional Network based on Kipf and Welling 2017
This project originated as part of a deep learning course, where we implemented and analyzed the Graph Convolutional Network (GCN) proposed by Kipf and Welling. The repository contains the implementation, experimental extensions, and a short discussion of the results
